...
ax.plot(xq1, yq1, label="$m=1$", alpha=0.5, color='k', marker='o')
ax.plot(xq2, yq2, label="$m=1e-30$", color='magenta', alpha=0.5)
...
ax.set_title(r'Eccentric Test Orbit of Near Massless Point Mass') # Plot title
