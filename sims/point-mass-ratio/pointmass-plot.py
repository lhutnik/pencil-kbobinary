...
ax.plot(xq1, yq1, label="$m=0.5$", alpha=0.5)
ax.plot(xq2, yq2, label="$m=0.5$", color='magenta', alpha=0.5)
...
ax.set_title(r'Circular Test Orbit of Equal Mass Binary') # Plot title
